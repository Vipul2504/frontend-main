...
export default function Home({ products }) {
  ...
  return (
    <div className="min-h-screen w-full">
      <Head>
        <title>Furnito Official Website</title>
      ...
      <main className="flex flex-col justify-center items-center">
        ...
        <div className='w-full relative flex justify-center'>
          ...
          <div className="w-11/12 lg:w-9/12 p-6 absolute top-1/2 -translate-y-1/2">
            <h1 className="text-4xl text-white font-black uppercase">FIND YOUR &apos;Style</h1>
        ...
        <div className='w-11/12 lg:w-9/12 my-10'>
          <h1 className="font-bold text-3xl italic tracking-tighter uppercase mt-16 text-left">Premium Quality furniture</h1>
