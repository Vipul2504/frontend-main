        ...
        <div className="min-h-screen w-full">
            ...
            <main className="flex flex-col justify-center items-center mt-10">
                <div className="w-11/12 mt-6 px-2 lg:px-10">
                    ...
                    <p className='lg:w-1/2 text-sm my-2 mb-4'>With iconic designs and high-performance technologies, you can be sure that Design and quality wont let you down.</p>
                    <hr />
                    ...
                    <div className='my-16 mt-40'>
                        {/* <h1 className='text-3xl font-medium mb-2'>BEST BEDS</h1> */}
